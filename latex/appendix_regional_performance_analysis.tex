...
\section{Regional performance comparison }\label{appendix:regional_performance_analysis}

\subsection{Return on Advertising Spend (ROAS)} \label{appendix:regional_performance_analysis_ROAS}
...
\subsubsection{Descriptive Statistics} \label{appendix:regional_performance_analysis_CTR}
...
\subsubsection{Descriptive Statistics}\label{appendix:regional_performance_analysis_CVR}
...
\subsection{Cost Per Click (CPC)}\label{appendix:regional_performance_analysis_CPC}
