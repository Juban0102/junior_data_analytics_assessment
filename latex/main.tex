...
This document also includes interactive cross-references. Figure, table, equation, section, and appendix references are hyperlinked throughout the report, allowing readers to navigate directly to the referenced content by clicking the corresponding reference.
...
\input{task1_appendix}
\input{appendix_channel_performance_analysis}
\input{appendix_regional_performance_analysis}
